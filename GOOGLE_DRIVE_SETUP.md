...
หลังจาก Enable API แล้ว ไม่ต้องตั้งค่าอะไรเพิ่ม! เพราะ:
...
**เพียงแค่ Enable Google Drive API ใน Google Cloud Console** - Service Account ที่ตั้งค่าไว้แล้วจะใช้งานได้ทันที
